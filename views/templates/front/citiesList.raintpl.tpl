		...
		<ul class="list-group">
			...
			<li class="list-group-item" style="background-color: #f8f9fa; color : #343a40;border: 1px solid #6c757d;">
				<div style="display: table; width: 100%;">
					<!-- Name on the left -->
					<span style="display: table-cell; font-weight: bold;">{$value->name}</span>
					...
					<div style="display: table-cell; text-align: right; white-space: nowrap;">
						...
						<form method="post" action="index.php" class="form-inline" style="display:inline-block; margin-right:5px;">
							...
							<input type="hidden" name="id" value="{$value->id_city}">
						...
						<a href="index.php?name={$value->encodeCityName()}&id={$value->id_city}&api=OpenWeatherApi" 
							class="btn btn-info btn-xs" style="margin-left: 5px;">
							Open Weather
						</a>
						<a href="index.php?name={$value->encodeCityName()}&id={$value->id_city}&api=FreeWeatherApi" 
